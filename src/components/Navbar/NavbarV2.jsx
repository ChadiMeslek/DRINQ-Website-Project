...
const NavbarV2 = () => {
    ...
    const updateNavbar = () => {
      ...
      if (currentScroll <= 50) {
        ...
        if (currentScroll > lastScrollY) {
          document.body.classList.add("navbar-hidden"); // scrolling down
        } else {
          document.body.classList.remove("navbar-hidden"); // scrolling up
        }
        setScrolled(true);
      }
  ...
  return (
    <>
      {/* Navbar */}
      <nav
        className={`navbar-v2 navbar-expand-lg ${
          scrolled ? "navbar-v2-scrolled fixed-top" : "navbar-v2-top"
        }`}
      >
        <div
